    ...
    <>
      ...
      <div className="row gutters">
        ...
        <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
          <div className="card">
            <div className="card-header">
              <div className="card-title">Hisobot</div>
            </div>
            <div className="card-body">
              <table className="table table-sm">
                <tfoot>
        ...
        <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12">
          <div className="card">
            <div className="card-header">
              <div className="card-title">To'lov qabul qilish</div>
            </div>
            <div className="card-body">
              <div className="row">
                  ...
                  >
                    <button
                      ...
                      className={`btn btn-sm py-1 ${
                        payment.type === "cash" ? "btn-warning" : "btn-success"
                      }`}
                    >
                      Naqt
                    </button>
                    <button
                      ...
                      type="button"
                      className={`btn btn-sm py-1 ${
                        payment.type === "card" ? "btn-warning" : "btn-success"
                      }`}
                    >
                      Plastik
                    </button>
                    ...
                    <button
                      ...
                      type="button"
                      className={`btn btn-sm py-1 ${
                        payment.type === "mixed" ? "btn-warning" : "btn-success"
                      }`}
                    >
                      Aralash
                    </button>
